import { BookHeart, Edit3, LockKeyhole, Sparkles } from 'lucide-react';
...
export const Diary = () => {
  const { entries, hasPasscode, unlocked, setupPasscode, unlock, lock } = useDiaryVault();
  ...
  return (
    <PageShell size="wide">
      <HeroPanel
        ...
        eyebrow="Diary room"
        title="diary"
        copy="需要口令才能进入的柔软日记房间。它可以写 Markdown，但阅读时仍然像纸页一样安静。"
        side={
